...
# Rota que falta ser criada na view, assim que criada alterar o nome da rota aqui e na controller
#Esse Rota vai na view users.index
Route::get('/edit-user', [UserController::class, 'edit'])->name('users.edit'); #tela de edição de um usuário específico

# Rota que falta ser criada na view, assim que criada alterar o nome da rota aqui e na controller
#Esse Rota vai na view users.index
Route::put('/update-user', [UserController::class, 'update'])->name('users.update'); #tela de atualizar de um usuário específico

# Rota que falta ser criada na view, assim que criada alterar o nome da rota aqui e na controller
#Esse Rota vai na view users.index
Route::delete('/destroy-user', [UserController::class, 'destroy'])->name('users.destroy'); #tela de deletar de um usuário específico
