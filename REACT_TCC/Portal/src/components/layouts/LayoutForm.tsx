    ...
    <div className="min-h-screen relative overflow-x-hidden font-['Segoe_UI'] text-[#333] leading-relaxed">
      ...
      <header className="bg-transparent text-white py-5 text-center relative z-10 font-Jersey">
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          />
          <h1 className="text-[2rem] md:text-[2.5rem] font-bold uppercase tracking-[2px] text-brand-secondary">
            Fatec PRUDENTE
          </h1>
          <h2 className="text-[1.1rem] md:text-[1.3rem] font-normal mb-8  text-[#d9d9d9] bg-brand-primary px-4 py-1 inline-block rounded-sm">
            Seleção de jogadores
          </h2>
        </div>
      </header>

      <main className="relative z-10 pb-10 font-Jersey">{children}</main>
    </div>
  );
};
