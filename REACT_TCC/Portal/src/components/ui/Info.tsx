...
const Info: React.FC<InfoProps> = ({ label = "Add Item" }) => {
  return (
    <div className="relative inline-block group">
      <div className="relative px-1 py-1 text-sm font-semibold text-white bg-gray-500 rounded-full hover:bg-indigo-700/90 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-300 overflow-hidden">
