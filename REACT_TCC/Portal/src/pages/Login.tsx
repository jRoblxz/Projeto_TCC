    ...
    <div className="min-h-screen bg-brand-primary flex items-center justify-center p-4">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-[800px] bg-white rounded-[10px] overflow-hidden shadow-[0px_15px_15px_rgba(0,0,0,0.5)]">
        ...
        <div className="w-full md:w-1/2 bg-white p-10 flex flex-col justify-center items-center">
          ...
          />
          <h2 className="text-4xl font-bold mb-2.5 text-[#851114]">
            FATEC PRUDENTE
          </h2>
        </div>

        {/* Lado Direito */}
        <div className="w-full md:w-1/2 bg-brand-secondary text-white p-10 flex flex-col justify-center">
          {/* Cabeçalho */}
          ...
          <a
            href="#"
            className="mt-4 text-xs text-[#c9c9c9] no-underline hover:text-white text-center block"
          >
            Esqueceu a senha
          </a>
          <button
