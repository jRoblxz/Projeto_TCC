...
import Logo from "@/assets/img/fatec.png"; // Trazendo a logo de volta!
    ...
    <Layout>
      ...
      */}
      <div className="max-w-[1200px] mx-auto px-5 relative -mt-[100px] md:-mt-[220px] z-20 pb-20">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] p-8 md:p-12 mb-16 border-b-8 border-brand-secondary text-center">
          <img
            src={Logo}
            alt="Logo Prudente"
            className="h-28 md:h-40 mx-auto mb-4 object-contain drop-shadow-md hover:scale-105 transition-transform"
          />
          <h1 className="text-3xl md:text-5xl font-extrabold uppercase tracking-widest text-brand-primary mb-3">
            Fatec Prudente
          </h1>
          <h2 className="text-lg md:text-xl font-bold bg-brand-secondary text-white px-8 py-2.5 inline-block rounded-full uppercase tracking-wider mb-6 shadow-md">
            Seleção de Jogadores
          </h2>
          <p className="text-gray-600 max-w-3xl mx-auto text-base md:text-lg font-medium leading-relaxed">
            Bem-vindo ao portal oficial de captação de talentos. Siga as
            instruções abaixo para realizar a sua inscrição e participar das
            peneiras do maior clube do Oeste Paulista.
          </p>
        </div>

        {/* === SESSÃO COMO FUNCIONA === */}
        <h2 className="text-center my-12 text-[2rem] font-extrabold text-brand-primary uppercase relative after:content-[''] after:block after:w-[80px] after:h-[5px] after:bg-brand-secondary after:mx-auto after:mt-3 after:rounded-sm">
          Como funciona?
        </h2>
        ...
        <div className="bg-brand-primary rounded-3xl p-8 md:p-12 text-white shadow-xl flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <ul className="space-y-4 text-gray-200 font-medium">
              <li className="flex items-start gap-3">
                ...
                <p>
                  É <strong>obrigatória</strong> a apresentação do RG original
                  ou certidão de nascimento no dia do teste.
                </p>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-brand-secondary mt-2 shrink-0"></div>
                <p>
                  Compareça com material de treino completo: chuteira, meião,
                  calção e camisa (não é permitido usar camisas de outros
                  clubes).
                </p>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-brand-secondary mt-2 shrink-0"></div>
                <p>
                  Obrigatório a apresentação de Atestado Médico de aptidão
                  física recente (emitido há menos de 6 meses).
                </p>
              </li>
            </ul>
          </div>
          ...
          <div className="shrink-0 w-full md:w-auto">
            <button
              ...
              className="w-full md:w-auto bg-brand-secondary hover:bg-[#b02222] text-white text-xl font-extrabold uppercase tracking-wide py-5 px-10 rounded-xl shadow-[0_5px_15px_rgba(148,27,27,0.4)] hover:-translate-y-1 transition-all duration-300"
            >
...
const StepCard = ({
  ...
  <div className="flex-1 min-w-[280px] bg-brand-secondary rounded-tr-[50px] rounded-bl-[50px] pt-4 pl-4 shadow-lg hover:-translate-y-2 transition-transform duration-300">
    <div className="bg-brand-primary rounded-tr-[40px] rounded-bl-[40px] p-8 text-center shadow-inner h-full flex flex-col relative overflow-hidden group">
      ...
      <div className="z-10 flex flex-col h-full">
        ...
        <h3 className="text-gray-300 text-xl font-extrabold uppercase mb-3 text-left">
          <span className="text-brand-secondary mr-2">{number}.</span> {title}
        </h3>
