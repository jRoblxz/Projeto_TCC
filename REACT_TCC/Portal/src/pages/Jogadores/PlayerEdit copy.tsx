...
const PlayerEdit: React.FC = () => {
  ...
  const inputClass =
    "w-full bg-[rgba(133,17,20,0.05)] border-2 border-dashed border-[rgba(133,17,20,0.3)] rounded text-center py-1 px-2 text-[#333] dark:text-white/60 focus:outline-none focus:bg-[rgba(133,17,20,0.05)] focus:border-[#851114] hover:bg-[rgba(190,18,23,0.1)] transition-colors";
  const selectClass =
    "w-full bg-[rgba(133,17,20,0.05)] border-2 border-dashed border-[rgba(133,17,20,0.3)] rounded text-center py-1 px-2 text-[#333] dark:text-white/60 focus:outline-none focus:border-[#851114] cursor-pointer hover:bg-[rgba(190,18,23,0.1)] appearance-none";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-8 p-4">
            ...
            <div className="bg-[#f8f9fa] dark:bg-gray-900 rounded-[15px] p-6 shadow-[0_5px_20px_rgba(0,0,0,0.05)]">
              ...
              <div className="grid grid-cols-2 gap-4 mb-5">
                ...
                <div className="bg-white dark:bg-gray-800 dark:border-gray-700 p-3 rounded-lg shadow-sm text-center">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`${selectClass} text-[#ff4757] font-bold`}
                  >
                ...
                <div className="bg-white dark:bg-gray-800 dark:border-gray-700 p-3 rounded-lg shadow-sm text-center col-span-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`${selectClass} text-[#4787ff] font-bold`}
                  >
              ...
              <div className="w-full h-[200px] bg-[#28a745] rounded-[10px] relative mt-4 shadow-inner overflow-hidden border-2 border-[#1e7e34]">
                ...
                {primCoords && (
                  <div
                    className="absolute w-5 h-5 bg-[#ff4757] border-[3px] border-white rounded-full -translate-x-1/2 -translate-y-1/2 shadow-lg z-10 animate-pulse"
                    style={{
                      top: `${primCoords.top}%`,
            ...
            <div className="bg-[#f8f9fa] dark:bg-gray-900 rounded-[15px] p-6 shadow-[0_5px_20px_rgba(0,0,0,0.05)] h-fit">
              <div className="bg-white dark:bg-gray-800 dark:border-gray-700 p-5 rounded-[10px] border-l-[5px] border-brand-primary shadow-sm mb-6">
                ...
                <p className="text-[#666] dark:text-gray-300 leading-relaxed text-sm">
                  Certifique-se de salvar as alterações após modificar os dados.
                  As notas de avaliação (Overall) são calculadas automaticamente
                  com base nas avaliações realizadas pelos treinadores e não
                  podem ser editadas manualmente aqui.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={item}
                    className="bg-white dark:bg-gray-800 dark:border-gray-700 p-4 rounded-[10px] text-center shadow-sm border-2 border-dashed border-[#e9ecef] opacity-70"
                  >
                    <h5 className="text-[#333] dark:text-white mb-2 font-bold ">
                      {item}
                    </h5>
