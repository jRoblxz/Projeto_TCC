            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {peneiras.length > 0 ? (
                peneiras.map((peneira) => (
                  <div
                    key={peneira.id}
                    className="bg-white dark:bg-gray-900 rounded-xl shadow-sm hover:shadow-lg transition border border-gray-200 dark:border-gray-700  flex flex-col justify-between overflow-hidden group"
                  >
                    <div className="p-5 border-b border-gray-100 dark:border-gray-700 ">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <span
                          className={`text-xs font-bold px-2 py-1 rounded uppercase border ${getStatusColor(peneira.status)}`}
                        >
                          {peneira.status
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 p-4 flex justify-between gap-2 border-t border-gray-100 dark:border-gray-700 ">
                      <button
                        ...
                        className="flex-1 flex justify-center gap-1 bg-green-600 hover:bg-green-700 text-white py-2 rounded text-xs font-bold transition"
                      >
                      ...
                      {isAdmin && (
                        <>
                          <button
                            onClick={() => handleOpenEdit(peneira)}
                            className="flex-1 flex justify-center gap-1 bg-yellow-500 hover:bg-yellow-600 text-white py-2 rounded text-xs font-bold transition"
                          >
                          ...
                          <button
                            ...
                            className="flex-1 flex justify-center gap-1 bg-red-600 hover:bg-red-700 text-white py-2 rounded text-xs font-bold transition"
                          >
              ...
              <form onSubmit={handleSave} className="p-6 space-y-4">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t">
                  <button
                    ...
                    className="px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded dark:hover:bg-gray-800 hover:bg-gray-200"
                  >
                    Cancelar
                  </button>
                  <button
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 text-center animate-in fade-in zoom-in duration-200">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Excluir <strong>"{selectedPeneira.title}"</strong> e todos os
                dados vinculados?
              </p>
