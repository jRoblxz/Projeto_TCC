          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-brand-primary dark:text-white flex items-center gap-2">
                <UserCheck className="text-brand-darkred" /> Editar Usuário
              </h1>
          ...
          >
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <label
                  className={`flex-1 flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all ${formData.role === "treinador" ? "border-brand-darkred bg-red-50 dark:bg-red-900/20" : "border-gray-200 dark:border-gray-600 hover:border-gray-300"}`}
                >
                  <input
                    type="radio"
                    name="role"
                ...
                <label
                  className={`flex-1 flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all ${formData.role === "adm" ? "border-brand-primary bg-blue-50 dark:bg-blue-900/20" : "border-gray-200 dark:border-gray-600 hover:border-gray-300"}`}
                >
                  <input
                    type="radio"
                    name="role"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_200px] gap-8">
              <div className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 rounded-xl focus:ring-2 focus:ring-brand-darkred outline-none transition"
                    />
                  </div>
                </div>
                ...
                <div className="bg-orange-50 dark:bg-orange-900/10 p-4 rounded-xl border border-orange-100 dark:border-orange-900/30">
                  <p className="text-xs font-bold text-orange-800 dark:text-orange-300 mb-4 uppercase">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 rounded-lg outline-none transition text-sm"
                      />
                    </div>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
              ...
              <div className="flex flex-col items-center justify-start">
                ...
                <label className="w-40 h-40 rounded-full border-4 border-dashed border-gray-200 dark:border-gray-700 flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-800 cursor-pointer hover:border-brand-darkred transition-all overflow-hidden relative group">
                  {fotoPreview ? (
                    <>
                      <img
                        src={fotoPreview}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl resize-none"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="pt-8 border-t border-gray-100 flex flex-col-reverse md:flex-row justify-end gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-8 py-3 font-bold text-white bg-brand-primary hover:bg-[#1e3a8a] rounded-xl shadow-lg transition-colors flex items-center justify-center gap-2"
              >
                {loading ? (
